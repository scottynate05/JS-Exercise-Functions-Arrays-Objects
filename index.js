...
*/
function getLastCarInfo(info) {
  const lastCar = info[info.length -1]
  return `This is a ${lastCar.car_make} ${lastCar.car_model}`/* code here */
}
...
function getCarInfoById(inventory, id) {
  ...
  return `This is a ${carId.car_make} ${carId.car_model}` /* code here */
}
...
function getModelYears(inventory) {
  ...
  for(let i=0; i<inventory.length; i++) {
    inv[i] = inventory[i].car_year;
  }
  return inv; /* code here */
}
